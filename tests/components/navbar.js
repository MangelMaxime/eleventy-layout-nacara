...
(0, ava_1.default)("minimal navbar is generated if no navbar.nacara data is provided", async (t) => {
    const elev = new Eleventy("./fixtures/navbar-0/", "./fixtures/navbar-0/_site", {
        configPath: "./fixtures/navbar-0/.eleventy.js",
    });
    const json = await elev.toJSON();
    const formattedResult = (0, _formatHTML_1.formatHTML)(json[0].content);
    t.is(formattedResult, `<nav
...
(0, ava_1.default)("supports simple link elements in the start section", async (t) => {
    const elev = new Eleventy("./fixtures/navbar-1/", "./fixtures/navbar-1/_site", {
...
(0, ava_1.default)("pinned simple link elements are always displayed on mobile", async (t) => {
    const elev = new Eleventy("./fixtures/navbar-2/", "./fixtures/navbar-2/_site", {
...
(0, ava_1.default)("navbar endItems are rendered using their icons on desktop only and rendered using their label in the mobile menu", async (t) => {
    const elev = new Eleventy("./fixtures/navbar-3/", "./fixtures/navbar-3/_site", {
