...
test("supports Lucide icons out of the box", async (t) => {
...
test("throw an Error if the Lucide icons is not found", async (t) => {
    const iconBuilder = toIconFilterBuilder();
    const error = await t.throwsAsync(iconBuilder("lucide:unknown"));
    t.is(error?.message, "Icon 'unknown' not found in Lucide");
});

test("supports Simple Icons icons out of the box", async (t) => {
    const iconBuilder = toIconFilterBuilder();
...
test("throw an Error if the Simple Icons icons is not found", async (t) => {
    const iconBuilder = toIconFilterBuilder();
    const error = await t.throwsAsync(iconBuilder("simpleIcons:unknown"));
    t.is(error?.message, "Icon 'unknown' not found in simple-icons");
});

test("support SVG files located in the assets folder out of the box", async (t) => {
    const iconBuilder = toIconFilterBuilder();
...
test("throw an Error if the SVG file is not found", async (t) => {
    const iconBuilder = toIconFilterBuilder();
